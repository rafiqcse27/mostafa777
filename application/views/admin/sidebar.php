  ...
  <div class="page-sidebar" id="main-menu">
    ...
    <div class="page-sidebar-wrapper" id="main-menu-wrapper">
      <div class="user-info-wrapper">
        <div class="profile-wrapper"> <img src="<?=$this->config->item('admin_assets_url');?>assets/img/profiles/avatar.jpg"  alt="" data-src="<?=$this->config->item('admin_assets_url');?>assets/img/profiles/avatar.jpg" data-src-retina="<?=$this->config->item('admin_assets_url');?>assets/img/profiles/avatar2x.jpg" width="69" height="69" /> </div>
        <div class="user-info">
