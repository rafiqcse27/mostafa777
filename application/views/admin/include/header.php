...
<link href="<?=$this->config->item('admin_assets_url');?>assets/plugins/jquery-polymaps/style.css" rel="stylesheet" type="text/css" media="screen"/>
<link href="<?=$this->config->item('admin_assets_url');?>assets/plugins/jquery-metrojs/MetroJs.css" rel="stylesheet" type="text/css" />
<link rel="stylesheet" type="text/css" href="<?=$this->config->item('admin_assets_url');?>assets/plugins/shape-hover/css/demo.css" />
<link rel="stylesheet" type="text/css" href="<?=$this->config->item('admin_assets_url');?>assets/plugins/shape-hover/css/component.css" />
<link rel="stylesheet" type="text/css" href="<?=$this->config->item('admin_assets_url');?>assets/plugins/owl-carousel/owl.carousel.css" />
<link rel="stylesheet" type="text/css" href="<?=$this->config->item('admin_assets_url');?>assets/plugins/owl-carousel/owl.theme.css" />
...
<link href="<?=$this->config->item('admin_assets_url');?>assets/plugins/jquery-slider/css/jquery.sidr.light.css" rel="stylesheet" type="text/css" media="screen"/>
<link rel="stylesheet" href="<?=$this->config->item('admin_assets_url');?>assets/plugins/jquery-ricksaw-chart/css/rickshaw.css" type="text/css" media="screen" >
<link href="<?=$this->config->item('admin_assets_url');?>assets/plugins/jquery-isotope/isotope.css" rel="stylesheet" type="text/css"/>
...
<link href="<?=$this->config->item('admin_assets_url');?>assets/css/magic_space.css" rel="stylesheet" type="text/css"/>
<link href="<?=$this->config->item('admin_assets_url');?>assets/css/tiles_responsive.css" rel="stylesheet" type="text/css"/>
<!-- END CSS TEMPLATE -->
</head>
<!-- END HEAD -->
<!-- BEGIN BODY -->
...
<div class="header navbar navbar-inverse ">
  ...
  <div class="navbar-inner">
    <div class="header-seperation">
      ...
      <!-- BEGIN LOGO -->
      <a href="index.html"><img src="<?=$this->config->item('admin_assets_url');?>assets/img/logo.png" class="logo" alt=""  data-src="<?=$this->config->item('admin_assets_url');?>assets/img/logo.png" data-src-retina="<?=$this->config->item('admin_assets_url');?>assets/img/logo2x.png" width="106" height="21"/></a>
      <!-- END LOGO -->
    ...
    <div class="header-quick-nav" >
      ...
      <div class="pull-right">
        <div class="chat-toggler"> <a href="#" class="dropdown-toggle" id="my-task-list" data-placement="bottom"  data-content='' data-toggle="dropdown" data-original-title="Notifications">
          ...
          <div class="profile-pic"> <img src="<?=$this->config->item('admin_assets_url');?>assets/img/profiles/avatar_small.jpg"  alt="" data-src="<?=$this->config->item('admin_assets_url');?>assets/img/profiles/avatar_small.jpg" data-src-retina="<?=$this->config->item('admin_assets_url');?>assets/img/profiles/avatar_small2x.jpg" width="35" height="35" /> </div>
        </div>
        <ul class="nav quick-section ">
