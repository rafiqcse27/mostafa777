...
$config['message_start_delimiter'] = '<div class="alert alert-success"><button data-dismiss="alert" class="close"></button>'; 	// Message start delimiter
$config['message_end_delimiter']   = '</div>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<div class="alert alert-error"><button data-dismiss="alert" class="close"></button>';		// Error mesage start delimiter
